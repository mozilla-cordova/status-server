...
module.exports.fetchRepos = function () {
    ...
    function getRepoInfo(repo) {
        ...
        .spread(function(apacheCommits, mozCommits, apacheBranches, mozBranches, pullRequests) {
            ...
            var mozRequests = pullRequests.filter(function (pr) {
